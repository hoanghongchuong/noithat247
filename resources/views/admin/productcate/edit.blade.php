        	...
        	<form method="post" action="backend/productcate/edit?id={{$id}}" enctype="multipart/form-data">
			    ...
			    <div class="col-md-6">
				    ...
				    <div class="form-group">
				   	...
				   	<div class="form-group">
					    <label>
				        	<input type="checkbox" name="show_sidebar" {!! (!isset($data->show_sidebar) || $data->show_sidebar==1)?'checked="checked"':'' !!}> Hiển thị sidebar
				    	</label>
				    </div>
				    <div class="form-group">
					    <label>
				        	<input type="checkbox" name="show_menu" {!! (!isset($data->show_menu) || $data->show_menu==1)?'checked="checked"':'' !!}> Hiển thị menu
				    	</label>
				    </div>
